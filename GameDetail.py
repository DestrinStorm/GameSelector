...
class Ui_GameDetail(object):
    def setupUi(self, GameDetail):
        ...
        self.imageDisplay = QtWebEngineWidgets.QWebEngineView(GameDetail)
        self.imageDisplay.setGeometry(QtCore.QRect(660, 60, 450, 350))
        ...
        self.imageDisplay.setUrl(QtCore.QUrl("about:blank"))
        self.imageDisplay.setZoomFactor(2.0)
        self.imageDisplay.setObjectName("imageDisplay")
        self.description = QtWebEngineWidgets.QWebEngineView(GameDetail)
        self.description.setGeometry(QtCore.QRect(10, 40, 521, 701))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.description.setFont(font)
        self.description.setUrl(QtCore.QUrl("about:blank"))
